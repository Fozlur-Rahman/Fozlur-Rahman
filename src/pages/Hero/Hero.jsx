...
const Hero = () => {
    return (
        <>
            <section className="hero-section md:h-[90vh] pt-20">
                ...
                <div className="section-container h-full md:flex md:justify-between md:items-center space-y-20">
                    ...
                    <div className="space-y-10">
                        <div>
                            ...
                            <h1 className="hero-title text-7xl font-bold mt-1 text-white">Fozlur Rahman Zishan
                            </h1>

                        </div>
                        <div>
                            <h3 className="text-xl high-light-text">
                                <TypeAnimation
                                    sequence={[
                                        'Front',
                                        500,
                        ...
                        <div className="space-x-5">
                            <button className="primary-btn py-10">Hire Me</button>
